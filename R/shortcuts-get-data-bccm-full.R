...
#'
#' \describe{
#'   \item{bottom}{sea bottom}
#'   \item{0to40}{average between 0m and 40m depth}
#'   \item{40to100}{average between 40m and 100m depth}
#'   \item{100tobot}{average between 100m depth and sea bottom}
#'   \item{surface}{sea surface}
#' }
#' 
