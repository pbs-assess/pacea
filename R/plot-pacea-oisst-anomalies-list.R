...
##'
##' Does a spatial plot of the absolute anomalies with one map for each month and year
##' (default is the latest month of data) if `heatmap_style = FALSE`. See
##' [plot.pacea_oianom()] for arguments.
##'
