...
pacea is intended to be a data platform containing somewhat disparate data
...
yet. We plan to release it in October 2023. To install the latest version:
...
You can install the development version of pacea from [GitHub](https://github.com/) with:
