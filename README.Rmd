...
**NOTE:** pacea will be released on 10th November 2023, and we are still developing and
editing it before then. So while you can download it before then, it might be
best to wait as we are still editing help files, vignettes, code, etc. (and code
will change).
...
Kelsey Flynn, Jessica Nephin, Strahan Tucker, Matt Grinnell, Lindsay Davidson,
Sean Anderson, Philina English, and Chris Grandin.
