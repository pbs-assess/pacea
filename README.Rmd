...
Currently, pacea contains:
 ...
 - outputs from the British Columbia continental margin (BCCM) model, including:
   ...
   - various depth intervals (for applicable variables) are: surface, bottom, 0m - 40m depth, 40m - 100m depth, and 100m to bottom depth.
