...
pacea is a data platform containing somewhat a variety of data
...
Currently, pacea contains:
 ...
 - outputs from the spatial British Columbia continental margin (BCCM) model, including:
   - dissolved oxygen concentration, pH, salinity, and temperature at various depths, as well as surface phytoplankton and primary production.
   - various depth intervals (for applicable variables): surface, bottom, 0m - 40m depth, 40m - 100m depth, and 100m to bottom depth.
   - gridded to 2km x 2km inshore and 6km x 6km offshore for a total of 40,580 cells across the Canada's Pacific EEZ
 ...
 - climatic and oceanographic indices, such as the Pacific Decadal Oscillation
...
What were the differences in spatial pattern of sea surface temperature in the Pacific between June 2022 and 2023?
```{r oisst}
