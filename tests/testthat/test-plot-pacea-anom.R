...
test_that("plot works for bccm anom data", {
  ...
  skip_on_ci()  # Getting 403 timeout errors when trying to download data
...
test_that("plot works for oisst anom data", {
  ...
  expect_true(ggplot2::is_ggplot(p1w))
  expect_true(ggplot2::is_ggplot(p2w))
  expect_true(ggplot2::is_ggplot(p3w))

  expect_true(ggplot2::is_ggplot(p1m))
  expect_true(ggplot2::is_ggplot(p2m))
  expect_true(ggplot2::is_ggplot(p3m))
})
