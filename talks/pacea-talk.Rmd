---
title: "pacea"
subtitle: "New Canadian and US information added to pacea (since last year)"
...
rmarkdown::render("pacea-talk.Rmd")
...
knitr::opts_chunk$set(
  ...
  #out.height = 400
  cache = TRUE,
  cache_path = "pacea-talk-cache/",
  fig.path = "pacea-talk-cache-figs/"
)
...
```{r ecosystemsummary, child = "ecosystem-summary.Rmd", eval = FALSE}
```

```{r summary, child = "summary.Rmd", eval = long_talk}
```

```{r summaryshort, child = "summary-short.Rmd", eval = short_talk}
```
