...
pacea-talk-short.Rmd for FUTURE Habitat talk plus Molecular Genetics section
  meeting and pacea palooza 2025
...
explain_assessment <- FALSE   # set to TRUE for two slides explaining stock
  # assessment, did not work for palooza so just commenting out
...
knitr::include_graphics(paste0(here::here(),
                               "/talks/talks-manual-figures/pacea-title-slide-palooza-2025.png"))
```
...
```{r paloozaplan, child = "palooza-plan.Rmd", eval = short_talk}
```
