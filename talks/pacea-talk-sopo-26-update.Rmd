---
title: "pacea"
subtitle: "New infomation added to pacea since last year's SOPO"
...
rmarkdown::render("pacea-talk-sopo-26-update.Rmd")
...
knitr::opts_chunk$set(
  ...
  #out.height = 400
  cache = TRUE,
  cache_path = "pacea-talk-sopo-26-update-cache/",
  fig.path = "pacea-talk-sopo-26-update-cache-figs/"
)
...
knitr::include_graphics(paste0(here::here(),
                               "/talks/talks-manual-figures/pacea-title-slide-sopo-2026.png"))
```
...
```{r introductionshort, child = "introduction-short.Rmd", eval = long_talk}
```
...
```{r fraser, child = "fraser.Rmd", eval = short_talk}
```
...
```{r bccmshort, child = "bccm-short.Rmd", eval = long_talk}
```
...
```{r summaryshort, child = "summary-sopo-26.Rmd", eval = short_talk}
```
