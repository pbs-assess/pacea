...
`hotssea_avg0to30m_temperature_min` is, for each month and spatial cell, the depth-integrated mean (over the top 30 m) of each modelled depths’ minimum (over the month) daily mean temperature.
