...
BCCM data can be plotted using the `plot()` function for a quick view of the data. The default settings are to plot the April every five years for the time series available.
...
NOTE: 
Again, `ggplot()` recognizes that the projection of bc_coast and bc_eez shapefile are different thanthe BCCM data (NAD 83), and will reproject the layers to match the first layer.
