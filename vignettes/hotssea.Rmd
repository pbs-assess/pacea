...
- for calculations that are averages over a depth range, such as
  ...
  average the values over all cells within that depth range.
...
output to our designated variable simply names `hot`.
...
the mean (over the top 30 m) of each modelled depths' maximum (over the month) daily mean temperature.
...
So let's ask: how do the anomalies of minimum (over each month) daily mean bottom temperature for
