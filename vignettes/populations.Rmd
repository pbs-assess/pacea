...
<!-- To build either run
   rmarkdown::render("fish_populations.Rmd")
...
and these estimates will be updated in `pacea` probably around February. So
...
(2022; SAR 2022/034), and included in `pacea` as:
```{r seals}
harbour_seals
