...
The locations of the buoys are shown at
https://github.com/IOS-OSD-DPG/Pacific_SST_Monitoring#eccc-buoy-data .

Some of the data are also plotted there, by Andrea Hilborn,
...
`plot(buoy_sst)` function calls our tailored `plot.pacea_buoy()` function. This
buoy seems to have stopped relaying data in May 2023 -- if it has since
continued you will see the red line continuing (if you're building it in 2023) in the above plot.
