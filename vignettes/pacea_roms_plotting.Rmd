...
Here, we plot the ROMS data using some built in package functions, as well as `ggplot2`. We introduce some of the available polygon shapefile layers that can be plotted with the ROMS data.
