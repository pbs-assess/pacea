...
# Playing around for hexSticker, but need better resolution and should usual
#  a final mapped example. Trying to do quickly for SOPO.
plot(sst_time_1_sf, axes = TRUE,
     pch = 20,
     cex = 0.8,
     xlim = c(-128, -123),
     ylim = c(48, 51))    # think it kind of ignores xlim or ylim
