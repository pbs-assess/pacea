...
HERE - redo this but not for first row as
that's way down off Oregon. Make an sf object then do the clip thing to be only north of XX and then try.
...
# ---
# DON'T THINK NEEDED
# So I'm not sure why I did this, surely want to go the other way (trying other
#   way later):

#test_grid_20_lon_lat <- sf::st_transform(test_grid_20,
# sf::st_crs(sst_time_1_sf))

# sf::st_crs(test_grid_20_lon_lat)

# xx <- stars::st_rasterize(sst_time_1_sf,
#                          stars::st_as_stars(test_grid_20_lon_lat))
...
#stars:::is_regular_grid(test_grid_20_lon_lat)    # FALSE
# still didn't work, not quite sure why.
# ---

# This seems like should work, but see above

# Try instead to convert sst values into km as for grid
