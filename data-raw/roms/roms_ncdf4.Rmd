...
# Seem to want to use stars::st_rasterize to the conversion to the master grid:
#  xx <- stars::st_rasterize(sst_time_1_sf, test_grid_20)   # but need
#  test_grid_20 as a stars object.
...
try fasterize, though may need to create the grid as a raster
