...
## Obtaining the Coastwide Indices

This markdown document shows how the oceanographic basin indices are compiled into PACea. Thanks to Chris Rooper for sharing the code
...
Note that these time-series' of oceanographic indices are NOT stored across the BC grid. This saves a lot of space. Instead, PACea recognises that a covariate is `coastwide' if the `Poly_ID` value is set to `-1`.
