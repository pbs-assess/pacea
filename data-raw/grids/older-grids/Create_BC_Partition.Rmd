...
index_vectors <- 
  list(`BC Grid` = which(BC_Partition$Regions_Name=="BC Grid"),
       `BC Major Area Boundaries` = which(BC_Partition$Regions_Name=="BC Major Areas"),
       `Pacific Herring Sections` = which(BC_Partition$Regions_Name=="Pacific Herring Spawn Statistical Areas"))
